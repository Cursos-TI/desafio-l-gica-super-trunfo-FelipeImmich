...
Atributos menuAtributo(int d)
{
    ...
    if (atributo.atributo > 0 && atributo.atributo < 8)
    {
        return atributo;
    }
    else{
...
int main()
{
    ...
    int num_cartas;
    quantidade_de_cartas_a_cadastrar:
    ...
    if (num_cartas <= 1)
    {
        ...
        goto quantidade_de_cartas_a_cadastrar;
    }
    ...
    primeira_carta_comparacao:
    printf("\nDigite a primeira carta: ");
    scanf("%d", &cartaPrimeira);
    if (cartaPrimeira <= 0 || cartaPrimeira > num_cartas) {
        printf("##### Opcao Invalida! #####\n");
        goto primeira_carta_comparacao;
    }
    
    segunda_carta_comparacao:
    printf("\nDigite a segunda carta: ");
    scanf("%d", &cartaSegunda);
    if (cartaSegunda <= 0 || cartaSegunda > num_cartas){
        printf("##### Opcao Invalida! #####\n");
        goto segunda_carta_comparacao;
    }
